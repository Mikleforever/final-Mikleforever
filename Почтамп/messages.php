...
<div class="messages-main"  style="padding:0px;" >
    <div class="m-left">
    <?php
            ...
            if ($allfriends != ''){
                ...
                ?>
                    <div class="messages-friend" onclick="startLoop(<?php echo $user['id'].',\''.$user['name'].'\''; ?>)">
                        <div style="background-image:url(<?php echo(json_decode($user['info_json'])->avatar);?>);  width:200px; height:4vw; background-repeat: no-repeat;background-size: contain;"></div>
                        <h2 class="messages-friend_text"><?php echo($user['name']); ?></h2>
                    </div>
                <?php
            }
        }
    ...
    <div class="m-right">
        ...
        <div class="user-input" style=" font-size: 18px;">
            <textarea name="message" id="mess" cols="30" rows="10"></textarea>
            <button class="send_button" style="  cursor:pointer; " type="submit" name="postinuserprofile" onclick="send()">Отправить</button>
