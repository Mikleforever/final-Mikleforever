<div class="user-card-all" style="display:flex; flex-wrap:wrap;">
        ...
        for ($i=0; $i < count($allfriends); $i++) { 
            if ($allfriends != ''){
                ...
                ?>
                <div class="user-card-posts" style="display:flex; height:230px; width:40%; margin-right:0.8%; flex-wrap:wrap;">
                    ...
                    <form action="" method="post" style="width:100%; margin-top:1vw;">
                        ...
                        <button class="delete_button" type="submit" style="  cursor:pointer; " name="deleteGo">Удалить</button>
                    </form>
                </div>
    ...
    <?php
        ...
        if (count($allfriends) == 0){
            ?>
                <br><h2 style="text-align:center;">У вас ещё нет друзей</h2>
            <?php
        }
    ?>