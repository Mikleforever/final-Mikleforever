        ...
        <div class="postImages">
            <?php 
                for ($j=0; $j < count($images); $j++) { ?>
                    <div style="height:100%; overflow:hidden;width:<?php echo (100/count($images));?>%;"><a style="width:100%;" href="<?php echo($images[$j]);?>" target_="_blank"> <img style="width:100%; cursor:pointer;" src="<?php echo($images[$j]);?>"></a></div>
...
<button class="news_button" style=" cursor:pointer; " onclick="get()">Загрузить ещё</button>